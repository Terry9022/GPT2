...
def set_args():
    ...
    parser.add_argument('--train_file_path', default='./data_dir/train_data.json',type=str, help='training dataset location')
    parser.add_argument('--test_file_path', default='./data_dir/test_data.json',type=str, help='testing dataset location')
    parser.add_argument('--pretrained_model_path',default='./pretrain_model',type=str, help='pretrained model location ')
    ...
    parser.add_argument('--eval_steps',default=1000,type=int,help='how many step do we evaluate the model when training')
